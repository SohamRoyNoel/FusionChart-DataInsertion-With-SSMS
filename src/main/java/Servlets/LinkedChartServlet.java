...
public class LinkedChartServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public LinkedChartServlet() {
        super();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String askFusion = "select name, avg(payment) from DependentTable group by name";
		String fm = "";
		String appendMe = "";
